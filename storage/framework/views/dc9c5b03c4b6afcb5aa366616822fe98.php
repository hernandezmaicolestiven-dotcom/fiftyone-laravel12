...
<div class="pt-24 pb-16 max-w-7xl mx-auto px-4">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-2"><?php echo e(count($products)); ?> productos disponibles</p>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-white rounded-2xl overflow-hidden shadow-sm border hover:shadow-lg transition-all">
            <div class="relative aspect-square bg-gray-100">
                <img src="<?php echo e($product->image ?? 'https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=400'); ?>" 
