...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <form method="POST" action="<?php echo e(route('customer.password.email')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
        ...
        <div class="mt-6 pt-5 border-t border-gray-100 text-center">
            <p class="text-sm text-gray-500">
                ¿Recordaste tu contraseña? <a href="<?php echo e(route('customer.login')); ?>" class="text-indigo-600 font-semibold hover:underline">Inicia sesión</a>
            </p>
        </div>
    </div>
...
<?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views\customer\auth\forgot-password.blade.php ENDPATH**/ ?>