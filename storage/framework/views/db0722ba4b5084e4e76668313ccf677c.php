...
<div class="grid grid-cols-2 xl:grid-cols-6 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-5 relative overflow-hidden">
        <div class="absolute -right-3 -top-3 w-14 h-14 rounded-full opacity-10" style="background:linear-gradient(135deg,<?php echo e($c1); ?>,<?php echo e($c2); ?>)"></div>
        <div class="w-9 h-9 rounded-xl mb-3 flex items-center justify-center" style="background:<?php echo e($bg); ?>">
            <i class="fa-solid <?php echo e($icon); ?> text-xs" style="background:linear-gradient(135deg,<?php echo e($c1); ?>,<?php echo e($c2); ?>);-webkit-background-clip:text;-webkit-text-fill-color:transparent"></i>
        </div>
...
<div class="mb-6 p-4 rounded-2xl flex items-center gap-4 <?php echo e($growthRate >= 0 ? 'bg-emerald-50 border border-emerald-200' : 'bg-red-50 border border-red-200'); ?>">
    <div class="w-10 h-10 rounded-xl flex items-center justify-center <?php echo e($growthRate >= 0 ? 'bg-emerald-100' : 'bg-red-100'); ?>">
        <i class="fa-solid <?php echo e($growthRate >= 0 ? 'fa-arrow-trend-up text-emerald-600' : 'fa-arrow-trend-down text-red-500'); ?>"></i>
    </div>
    <div>
        <p class="text-sm font-bold <?php echo e($growthRate >= 0 ? 'text-emerald-800' : 'text-red-700'); ?>">
            <?php echo e($growthRate >= 0 ? '+' : ''); ?><?php echo e($growthRate); ?>% vs <?php echo e($year - 1); ?>

        </p>
        <p class="text-xs <?php echo e($growthRate >= 0 ? 'text-emerald-600' : 'text-red-500'); ?>">
            Año anterior: $<?php echo e(number_format($prevYearRevenue, 0, ',', '.')); ?>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5 mb-5">
    ...
    <div class="xl:col-span-2 bg-white rounded-2xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-5">
            <div>
                <h3 class="text-sm font-bold text-gray-800">Ingresos mensuales <?php echo e($year); ?></h3>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        ...
        <p class="text-xs text-gray-400 mb-5"><?php echo e($year); ?></p>
...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h3 class="text-sm font-bold text-gray-800">Top 5 productos — <?php echo e($year); ?></h3>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-3 text-gray-400 font-mono text-xs"><?php echo e($i+1); ?></td>
                        <td class="px-6 py-3 font-medium text-gray-800"><?php echo e($p['name']); ?></td>
                        <td class="px-6 py-3 text-center font-bold text-gray-700"><?php echo e(number_format($p['qty'],0,',','.')); ?></td>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        ...
        ?>
        <div class="space-y-4">
            <?php $__currentLoopData = $prediction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-4 rounded-2xl" style="background:linear-gradient(135deg,rgba(124,58,237,.06),rgba(168,85,247,.06));border:1px solid rgba(124,58,237,.15)">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-semibold text-purple-700"><?php echo e($predMonths[$i]); ?></span>
                ...
                <div class="mt-2 h-1.5 bg-purple-100 rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-700" style="width:<?php echo e(round($val/$maxPred*100)); ?>%;background:linear-gradient(90deg,#7c3aed,#a855f7)"></div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <p class="text-xs text-gray-400 mt-4 text-center">
            ...
            Basado en tendencia de <?php echo e(count($months->where('revenue', '>', 0))); ?> meses con datos
        </p>
    </div>
</div>
...
<script>
(function(){
    const months  = <?php echo $months->pluck('month'); ?>;
    const revenue = <?php echo $months->pluck('revenue'); ?>;
    const orders  = <?php echo $months->pluck('orders'); ?>;
    const pred    = <?php echo json_encode($prediction); ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views\admin\analytics\index.blade.php ENDPATH**/ ?>