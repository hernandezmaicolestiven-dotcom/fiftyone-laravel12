...
<head>
<meta charset="UTF-8">
<title>Etiqueta #<?php echo e($order->id); ?></title>
<style>
...
.barcode .bars span { display:inline-block; width:<?php echo e(rand(2,4)); ?>px; height:40px; background:#1f2937; }
...
<div class="label">
    ...
    <div class="section">
        ...
        <?php if($order->shipping_address): ?><p class="sub">📍 <?php echo e($order->shipping_address); ?><?php echo e($order->city ? ', '.$order->city : ''); ?></p><?php endif; ?>
        <?php if($order->customer_phone): ?><p class="sub">📞 <?php echo e($order->customer_phone); ?></p><?php endif; ?>
        <?php if($order->customer_email): ?><p class="sub">✉️ <?php echo e($order->customer_email); ?></p><?php endif; ?>
    </div>
    ...
    <div class="barcode">
        <div class="bars">
            <?php for($i=0;$i<40;$i++): ?>
            <span style="width:<?php echo e(rand(1,4)); ?>px;height:<?php echo e(rand(30,45)); ?>px"></span>
            <?php endfor; ?>
        </div>
        <div class="num"><?php echo e(str_pad($order->id,6,'0',STR_PAD_LEFT)); ?>-FO</div>
    </div>
</div>
</div>
</body>
</html>
<?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views\admin\generators\label.blade.php ENDPATH**/ ?>