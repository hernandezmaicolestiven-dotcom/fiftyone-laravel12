...
<div class="rounded-2xl p-6 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
    ...
    <div>
        ...
        <p class="text-gray-400 text-sm mt-1"><?php echo e(now()->isoFormat('dddd, D [de] MMMM [de] YYYY')); ?></p>
    </div>
...
<div class="rounded-2xl border border-indigo-100 bg-indigo-50/50 dark:bg-indigo-900/10 dark:border-indigo-900/30 p-5 mb-6">
    <div class="flex items-center gap-2 mb-4">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400"><?php echo e(now()->format('d/m/Y')); ?> · Actualizado en tiempo real</p>
        </div>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $value, $diff, $icon, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div class="flex items-center justify-between mb-2">
                <i class="fa-solid <?php echo e($icon); ?> text-sm" style="color:<?php echo e($color); ?>"></i>
                <?php if($diff !== null): ?>
                <span class="text-xs font-bold px-2 py-0.5 rounded-full <?php echo e($diff >= 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-600'); ?>">
                    <?php echo e($diff >= 0 ? '+' : ''); ?><?php echo e($diff); ?>%
                </span>
                <?php endif; ?>
            </div>
            <p class="text-2xl font-black text-gray-900 dark:text-white"><?php echo e($value); ?></p>
            <p class="text-xs text-gray-400 mt-0.5 font-semibold uppercase tracking-wide"><?php echo e($label); ?></p>
        </div>
...
<div class="grid grid-cols-2 xl:grid-cols-5 gap-4 mb-6">
    ...
    <a href="<?php echo e(route('admin.products.index')); ?>"
       class="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 overflow-hidden relative">
        ...
        <p class="text-3xl font-black text-gray-800 mb-1"><?php echo e($stats['products']); ?></p>
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Productos</p>
        <p class="text-xs text-gray-400 mt-1"><?php echo e($stats['total_stock']); ?> uds. en stock</p>
    </a>
    ...
    <a href="<?php echo e(route('admin.categories.index')); ?>"
       class="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 overflow-hidden relative">
        ...
        <p class="text-3xl font-black text-gray-800 mb-1"><?php echo e($stats['categories']); ?></p>
    ...
    <a href="<?php echo e(route('admin.users.index')); ?>"
       class="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 overflow-hidden relative">
        ...
        <p class="text-3xl font-black text-gray-800 mb-1"><?php echo e($stats['users']); ?></p>
    ...
    <a href="<?php echo e(route('admin.orders.index')); ?>"
       class="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 overflow-hidden relative">
        ...
        <p class="text-3xl font-black text-gray-800 mb-1"><?php echo e($stats['orders']); ?></p>
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Pedidos</p>
        <p class="text-xs mt-1 <?php echo e($stats['orders_pending'] > 0 ? 'text-amber-500 font-medium' : 'text-gray-400'); ?>">
            <?php echo e($stats['orders_pending']); ?> pendientes
        </p>
    </a>
    ...
    <a href="<?php echo e(route('admin.products.index', ['stock' => 'low'])); ?>"
       class="group rounded-2xl p-5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 overflow-hidden relative
              <?php echo e($stats['low_stock'] > 0 ? '' : 'bg-white'); ?>"
       style="<?php echo e($stats['low_stock'] > 0 ? 'background: linear-gradient(135deg, #fff7ed, #fff)' : ''); ?>">
        ...
        <p class="text-3xl font-black mb-1 <?php echo e($stats['low_stock'] > 0 ? 'text-amber-600' : 'text-gray-800'); ?>">
            <?php echo e($stats['low_stock']); ?>

        </p>
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Stock bajo</p>
        <p class="text-xs mt-1 <?php echo e($stats['low_stock'] > 0 ? 'text-amber-500 font-medium' : 'text-gray-400'); ?>">
            <?php echo e($stats['out_stock']); ?> sin stock
        </p>
    </a>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5 mb-5">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <div class="flex gap-4 flex-shrink-0">
                    <div class="text-right">
                        ...
                        <p class="text-lg font-black text-gray-800"><?php echo e(\App\Models\Order::whereMonth('created_at', now()->month)->whereYear('created_at', now()->year)->count()); ?></p>
                    </div>
                    <div class="w-px bg-gray-100"></div>
                    <div class="text-right">
                        <p class="text-xs text-gray-400 mb-0.5">Ingresos mes</p>
                        <p class="text-lg font-black text-gray-800">$<?php echo e(number_format(\App\Models\Order::whereMonth('created_at', now()->month)->whereYear('created_at', now()->year)->sum('total'), 0, ',', '.')); ?></p>
                    </div>
                    <div class="w-px bg-gray-100"></div>
                    <div class="text-right">
                        <p class="text-xs text-gray-400 mb-0.5">Pendientes</p>
                        <p class="text-lg font-black <?php echo e($stats['orders_pending'] > 0 ? 'text-amber-500' : 'text-gray-800'); ?>"><?php echo e($stats['orders_pending']); ?></p>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        ...
        <div class="space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $topCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div>
                <div class="flex items-center justify-between mb-1">
                    ...
                    <span class="text-xs font-bold text-gray-500"><?php echo e($cat->products_count); ?></span>
                </div>
                <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-700"
                         style="width: <?php echo e($pct); ?>%; background: <?php echo e($colors[$i] ?? '#3B59FF'); ?>"></div>
                </div>
            </div>
        ...
        <div class="divide-y divide-gray-50">
            ...
            <div class="flex items-center gap-4 px-6 py-3.5 hover:bg-gray-50 transition">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-gray-800 truncate"><?php echo e($product->name); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e($product->category?->name ?? 'Sin categoría'); ?></p>
                </div>
                <div class="text-right flex-shrink-0">
                    ...
                    <p class="text-xs <?php echo e($product->stock < 5 ? 'text-amber-500 font-semibold' : 'text-gray-400'); ?>">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <span class="text-xs font-bold px-2.5 py-1 rounded-full bg-amber-100 text-amber-600">
                <?php echo e($stats['low_stock']); ?> alertas
            </span>
            <?php endif; ?>
        </div>
        <div class="divide-y divide-gray-50">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <div class="flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div class="h-full rounded-full <?php echo e($product->stock === 0 ? 'bg-red-500' : 'bg-amber-400'); ?>"
                                 style="width: <?php echo e(min($product->stock * 20, 100)); ?>%"></div>
                        </div>
                        <span class="text-xs font-bold <?php echo e($product->stock === 0 ? 'text-red-500' : 'text-amber-500'); ?>">
                            <?php echo e($product->stock); ?> uds.
                        </span>
                    </div>
                </div>
...
(function () {
    ...
    const orders   = <?php echo $chartData; ?>;
    const revenue  = <?php echo $chartRevenue; ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>