    ...
    <div class="px-6 py-4 border-t border-gray-100 dark:border-white/10">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                <?php else: ?>
                    <a href="<?php echo e($products->previousPageUrl()); ?>" class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition">
                        Anterior
                    </a>
                <?php endif; ?>
                ...
                <div class="flex gap-1">
                    <?php $__currentLoopData = $products->getUrlRange(max(1, $products->currentPage() - 2), min($products->lastPage(), $products->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($url); ?>" class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition">
                                <?php echo e($page); ?>
                ...
                <?php if($products->hasMorePages()): ?>
                    <a href="<?php echo e($products->nextPageUrl()); ?>" class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 transition">
                        Siguiente
                    </a>
                <?php else: ?>
                    <span class="px-3 py-2 rounded-lg text-sm font-medium text-gray-400 bg-gray-100 dark:bg-white/5 cursor-not-allowed">
