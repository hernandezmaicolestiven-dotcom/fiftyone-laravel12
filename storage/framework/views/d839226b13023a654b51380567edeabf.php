...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-lg font-semibold text-gray-800">Editar: <?php echo e($product->name); ?></h2>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('admin.products.update', $product)); ?>" enctype="multipart/form-data" class="space-y-5">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views\admin\products\edit.blade.php ENDPATH**/ ?>