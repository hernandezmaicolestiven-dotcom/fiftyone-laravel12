...
<?php $isPrint = request('print'); ?>


<?php echo $__env->make('admin.reports._nav', ['active' => 'sales'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<div class="bg-white rounded-2xl shadow-sm p-5 mb-5 <?php if($isPrint): ?> hidden <?php endif; ?>">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <div>
            ...
            <select name="status" class="border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 bg-gray-50">
                ...
                <?php $__currentLoopData = ['pending'=>'Pendiente','confirmed'=>'Confirmado','shipped'=>'Enviado','delivered'=>'Entregado','cancelled'=>'Cancelado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <a href="<?php echo e(route('admin.reports.sales')); ?>" class="px-4 py-2 rounded-xl border border-gray-200 text-sm text-gray-400 hover:text-red-500 hover:border-red-200 hover:bg-red-50 transition">
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5 mb-5">
    ...
    <div class="xl:col-span-2 bg-white rounded-2xl shadow-sm p-6">
        <div class="flex items-center justify-between mb-5">
            <div>
                ...
                <p class="text-xs text-gray-400"><?php echo e($dateFrom->format('d/m/Y')); ?> — <?php echo e($dateTo->format('d/m/Y')); ?></p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6">
        ...
        <div class="mt-4 space-y-1.5">
            <?php $donutColors = ['#f59e0b','#3b82f6','#6366f1','#10b981','#ef4444']; $di=0; ?>
            <?php $__currentLoopData = $statusCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lbl => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between text-xs">
                <span class="flex items-center gap-2">
                    <span class="w-2.5 h-2.5 rounded-full" style="background:<?php echo e($donutColors[$di++]); ?>"></span>
                    <?php echo e($lbl); ?>
...
<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-400"><?php echo e($totalCustomers); ?> clientes · Por ingresos generados en el período</p>
        </div>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-3 text-gray-400 font-mono"><?php echo e(($page - 1) * 10 + $i + 1); ?></td>
                    <td class="px-6 py-3 font-semibold text-gray-800"><?php echo e($c['name']); ?></td>
                    <td class="px-6 py-3 text-gray-500"><?php echo e($c['email']); ?></td>
                    <td class="px-6 py-3 text-center">
                        <span class="px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-700 text-xs font-semibold"><?php echo e($c['count']); ?></span>
                    </td>
                    <td class="px-6 py-3 text-right font-bold text-gray-800">$<?php echo e(number_format($c['total'],0,',','.')); ?></td>
                </tr>
    ...
    <?php if($customersPages > 1): ?>
    <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
        <p class="text-xs text-gray-400">Página <?php echo e($page); ?> de <?php echo e($customersPages); ?></p>
        <div class="flex gap-2">
            <?php if($page > 1): ?>
            <a href="<?php echo e(request()->fullUrlWithQuery(['customers_page' => $page - 1])); ?>"
               class="px-3 py-1.5 rounded-lg text-xs font-medium border border-gray-200 text-gray-600 hover:bg-gray-50 transition">
                ← Anterior
            </a>
            <?php endif; ?>
            <?php if($page < $customersPages): ?>
            <a href="<?php echo e(request()->fullUrlWithQuery(['customers_page' => $page + 1])); ?>"
               class="px-3 py-1.5 rounded-lg text-xs font-medium border border-gray-200 text-gray-600 hover:bg-gray-50 transition">
                Siguiente →
            </a>
...
(function(){
    ...
    new Chart(ctx,{
        ...
        data:{
            ...
            datasets:[
                {label:'Pedidos',data:<?php echo $chartOrders; ?>,borderColor:'#3B59FF',backgroundColor:gBlue,borderWidth:2,fill:true,tension:0.4,pointRadius:3,pointHoverRadius:6,yAxisID:'y'},
                {label:'Ingresos',data:<?php echo $chartRevenue; ?>,borderColor:'#10b981',backgroundColor:gGreen,borderWidth:2,fill:true,tension:0.4,pointRadius:3,pointHoverRadius:6,yAxisID:'y1'},
            ]
        },
        options:{
...
(function(){
    ...
    new Chart(ctx,{
        ...
        data:{
            ...
            datasets:[{data:<?php echo json_encode(array_values($statusCounts)); ?>,
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views/admin/reports/sales.blade.php ENDPATH**/ ?>