    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            <?php $__currentLoopData = [
                ...
                ['admin.invoices.index',    'fa-file-invoice',     'Facturas',           'admin.invoices*'],
        ...
        <div class="border-t border-white/10 px-4 py-4">
            <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 rounded-lg p-1 hover:bg-white/5 transition">
                <?php if(auth()->user()->avatar && file_exists(storage_path('app/public/' . auth()->user()->avatar))): ?>
                    <img src="<?php echo e(asset('storage/' . auth()->user()->avatar)); ?>?v=<?php echo e(auth()->user()->updated_at->timestamp); ?>" 
