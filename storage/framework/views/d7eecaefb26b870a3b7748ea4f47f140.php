                    ...
                    <td class="px-6 py-4">
                        <?php if($order->payment_method): ?>
                            <span class="px-2 py-1 rounded-lg text-xs font-semibold bg-emerald-50 text-emerald-700">
                                <i class="fa-solid fa-credit-card mr-1"></i><?php echo e(ucfirst($order->payment_method)); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>