...
<div class="w-full max-w-md">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <form method="POST" action="<?php echo e(route('customer.login.post')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center">
                <a href="<?php echo e(route('customer.password.request')); ?>" class="text-sm text-indigo-600 hover:underline">¿Olvidaste tu contraseña?</a>
            </div>
        </form>

        <div class="mt-6 pt-5 border-t border-gray-100 flex items-center justify-between">
            <p class="text-sm text-gray-500">
                ¿Sin cuenta? <a href="<?php echo e(route('customer.register')); ?>" class="text-indigo-600 font-semibold hover:underline">Regístrate gratis</a>
            </p>
            <a href="<?php echo e(route('admin.login')); ?>" class="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-xl border border-gray-200 text-gray-500 hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50 transition">
...
</html><?php /**PATH C:\Users\SoporteSENA\Downloads\fiftyone-laravel12-main\resources\views/customer/auth/login.blade.php ENDPATH**/ ?>